...
To use these stylesheets, rename the files and falanster with the name of your theme.
...
falanster-alpha-default-narrow.css  
...
falanster-alpha-default-normal.css
...
falanster-alpha-default-wide.css
